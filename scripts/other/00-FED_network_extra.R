...
# License: MIT
# Note: These summaries are separated from the main script because they take too long to run.
...
neighbour_pairs <- cache_rds("data/cached_data/FED_neighbour_edges.rds", {
...
province_shapes <- cache_rds("data/cached_data/province_shapes.rds", {
  FED_lookup_geo %>%
...
ggsave(
  "paper/static_figures/Figure_province_flow_candidates.png",
...
ggsave(
  "paper/static_figures/Figure_province_flow_EDAs.png",
