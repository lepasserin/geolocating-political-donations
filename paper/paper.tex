...
and Democrat candidates, a large majority of these donations orginated
...
competitveness strongly predicts the share of donor funding received
...
intensifies bias in opinition. Baker (2016) study the 2006-2010
...
Few studies analyze of out-of-district donation shares to Canadian
...
district associaitions (EDAs). We propose three potential reasons why.
...
donations are an unimortant piece of Canadian campaign financing.
...
local enitites to source most of it's funds directy from the central
...
government, and made publicly accesible (Elections Canada 2026d). In
...
Postal Code Coversion Files to match donor postal codes to the DAs of
...
accross the 42nd, 43rd, and 44th general elections. Data on electoral
outcomes was sourced from Open Government Canada (Treasury Board of
Canada Secretariat 2026), and it's use in our analysis is detailed in
...
We first provide summaries of all donations\footnote{From
  Chapter~\ref{sec-data} onwards, the terms ``donation'' and
...
analysis of out-of-district donations to localized entites.
...
2024. We note that by-electoral. Nomination contestants and by-electoral
...
contributions over \$200 to candidates (exluding by-elections) and
district associations that were recevied from outside their district,
...
contributions to candidates (exluding by-elections) over \$200 that were
...
demarkate the distances between Toronto and Calgary, and between Toronto
...
propensity, and quantify the reach of these donations. a first glimpse
of the spatial network formed by out-of-district donations. Our findings
are also contextualized within the broader scope of all Canadian federal
political contributions over \$200 during this time (see
Section~\ref{sec-data-summaries-situation}). We present and discuss our
major findings here, along with some notable study limitations.
...
candiates and district associations). Naturally, donation rates to these
two political entities varied through time; campaign funding was
...
high as 75\% in others (e.g.~Trinity --- St.~Paul's). While we might
...
difference, but it's scale speaks to a more fundamental difference
...
the total amount sent to localized entities) were exlcluded from our
...
funding pathways are contributions ot national parties and intra-party
