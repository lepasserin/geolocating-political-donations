...
source(here::here("other/presentation_dsi/presentation_helpers.R"))
...
- **END:** OOD not rigorously studied in other countries with this kind of geographically structured representation.
- **WHY**: large, generous individual donations limits, so there's just more money in politics to be influenced by, better political financing datasets.
:::
...
- Partnered with data scientists from the *Investigative Journalism Foundation* to format and clean this dataset.
- **Geolocated** donors within their districts using software tools developed by *Statistics Canada* and *Canada Post*.
:::
...
2. Out-of-district donation rates **vary predictably along socio-demographic lines**.
